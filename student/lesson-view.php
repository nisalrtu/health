        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between">
            <div class="flex-1">
                <div class="flex items-center mb-4">
                    ...
                    <span class="text-white opacity-75"><?php echo htmlspecialchars($lesson['module_title']); ?></span>
                    <span class="text-white opacity-50 mx-2">•</span>
                    <span class="text-white opacity-75">Lesson</span>
                </div>
                ...
                <div class="flex flex-wrap gap-4 text-sm">
                    <?php if ($lesson['estimated_duration']): ?>
                        <div class="bg-white bg-opacity-20 rounded-lg px-3 py-1">
                            <span class="text-white"><?php echo $lesson['estimated_duration']; ?> minutes</span>
                        </div>
                    <?php endif; ?>
                    <div class="bg-white bg-opacity-20 rounded-lg px-3 py-1">
                    ...
                    <?php if ($progress['status'] == 'completed'): ?>
                        <div class="bg-green-500 bg-opacity-80 rounded-lg px-3 py-1">
            ...
            <div class="mt-6 md:mt-0 md:ml-8">
                <div class="bg-white bg-opacity-20 rounded-xl p-6 text-center">
                    <div class="text-3xl font-bold text-white mb-2"><?php echo $lesson_progress; ?>%</div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 border-t border-gray-100 bg-gray-50">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <?php if ($progress['status'] != 'completed'): ?>
                            <form method="POST" class="inline" id="complete-lesson-form">
                        ...
                        <?php elseif (!$next_lesson && $progress['status'] == 'completed'): ?>
                            <a href="module-view.php?id=<?php echo $module_id; ?>&course_id=<?php echo $course_id; ?>" 
                               class="flex items-center px-6 py-3 bg-gray-600 text-white rounded-lg font-medium hover:bg-gray-700 transition duration-300">
                                Back to Module
                                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="space-y-3">
                    ...
                    <?php if ($lesson['estimated_duration']): ?>
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-gray-900 font-medium"><?php echo $lesson['estimated_duration']; ?> min</span>
                        </div>
                    <?php endif; ?>
                    
                    <div class="flex items-center justify-between">
                        <span class="text-gray-600">Order:</span>
                        <span class="text-gray-900 font-medium">Lesson <?php echo $lesson['order_sequence']; ?></span>
                    </div>
                        ...
                        <?php foreach ($quizzes as $quiz): ?>
                            <a href="quiz.php?id=<?php echo $quiz['id']; ?>&module_id=<?php echo $module_id; ?>&course_id=<?php echo $course_id; ?>" 
                               class="block p-3 bg-white rounded-lg border border-purple-200 hover:border-purple-300 transition duration-300">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <div class="font-medium text-purple-900"><?php echo htmlspecialchars($quiz['title']); ?></div>
                ...
                <div class="space-y-3">
                    <a href="module-view.php?id=<?php echo $module_id; ?>&course_id=<?php echo $course_id; ?>" 
                       class="flex items-center p-3 rounded-lg hover:bg-gray-50 transition duration-300">
                        ...
                        <div>
                            <div class="font-medium text-gray-900">Module Overview</div>
                    ...
                    <a href="course-view.php?id=<?php echo $course_id; ?>" 
                       class="flex items-center p-3 rounded-lg hover:bg-gray-50 transition duration-300">
                        ...
                        <div>
                            <div class="font-medium text-gray-900">Course Overview</div>
    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 transform transition-all">
        <div class="p-6">
            ...
            <div class="text-center mb-6">
                <h3 class="text-xl font-semibold text-gray-900 mb-3">Complete This Lesson?</h3>
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <button type="button" id="cancel-completion" 
                        class="flex-1 px-4 py-3 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 transition duration-300">
                    Cancel
                </button>
                <button type="button" id="confirm-completion"
                        class="flex-1 px-4 py-3 text-white rounded-lg font-medium hover:bg-opacity-90 transition duration-300"
                        style="background-color: #5fb3b4;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const sidebarContent = document.querySelector('.lg\\:col-span-1');
    ...
    const navigationButtons = document.querySelectorAll('a[href*="lesson-view"], a[href*="quiz.php"], a[href*="module-view"]');
